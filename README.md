...
Полный разбор архитектурных решений и доказательная база для каждого пункта
(конкретные адреса, tx hash, цифры с живых прогонов) — в
`BitOK_bridge_tracer_architecture.docx`, раздел 9.
